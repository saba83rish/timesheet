...
class ClientGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Client entity")
        ...
        .repeat(2) {
            ...
            .post("/api/clients")
            .headers(headers_http_authenticated)
            .body(StringBody("""{"id":null, "clientName":"SAMPLE_TEXT", "clientLocation":"SAMPLE_TEXT", "clientManagerName":"SAMPLE_TEXT", "projectJoiningDate":"2020-01-01T00:00:00.000Z", "projectEndingDate":"2020-01-01T00:00:00.000Z"}""")).asJSON
            .check(status.is(201))
